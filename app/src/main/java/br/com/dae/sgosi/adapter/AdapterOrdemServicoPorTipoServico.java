...
public class AdapterOrdemServicoPorTipoServico extends RecyclerView.Adapter<AdapterOrdemServicoPorTipoServico.MyViewHolder> {
    private List<OrdemServico> listaOrdemServico;

    public AdapterOrdemServicoPorTipoServico(List<OrdemServico> lista) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemLista = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_ordem_servico_por_tipo_servico, parent, false);
