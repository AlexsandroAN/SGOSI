...
public class AdapterOrdemServicoPorCliente extends RecyclerView.Adapter<AdapterOrdemServicoPorCliente.MyViewHolder> {
    private List<OrdemServico> listaOrdemServico;

    public AdapterOrdemServicoPorCliente(List<OrdemServico> lista) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View itemLista = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.adapter_ordem_servico_por_cliente, parent, false);
